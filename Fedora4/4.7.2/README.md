...
2. `docker run -it -p 8080:8080 -p 9080:9080 -d yinlinchen/fcrepo4-docker:4.7.2`
...
* Ubuntu 14.04 64-bit machine with: 
  ...
  * [Fedora 4.7.2](https://wiki.duraspace.org/display/FF/Downloads) at [http://localhost:8080/fcrepo](http://localhost:8080/fcrepo)
