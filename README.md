...
2. `docker run -it -p 8080:8080 -p 9080:9080 -d yinlinchen/fcrepo4-docker:4.3.0`
...
* Ubuntu 14.04 64-bit machine with: 
  ...
  * [Fuseki 2.3.0](https://jena.apache.org/documentation/serving_data/index.html) at [http://localhost:8080/fuseki](https://localhost:3030), for querying and updating.
    * Installed in "/usr/local/fuseki"
    * Dataset Path name "/test"
    * Persistent storage "/usr/local/fuseki/databases/test\_data"
  * [Fcrepo-camel-toolbox 4.x](https://github.com/fcrepo4-labs/fcrepo-camel-toolbox)
